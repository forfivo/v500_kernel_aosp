...
export INITRAMFS_TMP=~/Documentos/tmp/initramfs_source_$MODEL_$TYPE;
export INITRAMFS_SOURCE=$PARENT_DIR/wrkernel-$MODEL-$TYPE-ramdisk;
export PACKAGE_DIR=$KERNEL_DIR/OUTPUT
export CROSS_COMPILE=~/Documentos/AK-linaro/4.9.2-2014.08.20140901.CR83/bin/arm-cortex_a15-linux-gnueabihf-
export ARCH=arm
